...
if (age<18 && hasDrivingLicence ) {console.log("You're not allowed to drive yet.");else {console.log("the age is below 18 or the person doesn't have a driving licence and logs");
